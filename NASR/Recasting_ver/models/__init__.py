...
from Recasting_ver.run_manager import RunConfig
...
class CifarRunConfig(RunConfig):
    ...
    def __init__(self, save_path = './cifar', n_classes= 10, n_epochs=150, init_lr=0.05, lr_schedule_type='cosine', lr_schedule_param=None,
